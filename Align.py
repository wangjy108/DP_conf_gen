...
class Align():
    ...
    def align_by_crippen3D(rdmolobj_mol, rdmolobj_ref):
    ...
    def align_by_LSalignFlex(rdmolobj_mol, rdmolobj_ref):
        ...
        aligned_rdmolobj_search = [cc for cc in Chem.SDMolSupplier(f"Aligned_search_1.sdf")][0]
