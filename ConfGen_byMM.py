...
class ConfGen():
    ...
    def GenByMM(self, inputSMI:list, genConfNum:int, saveConfNum:int, save_file_name:str, DBprefix:str):
    ...
    def run(self):
        ...
        left_smi = run_dict[self.method](self.input_smi, \
                                         ...
                                         self.save_file_name,\
                                         self.serial_name)
        # GenByMM(inputSMI:list, genConfNum:int, saveConfNum:int, save_file_name:str, DBprefix:str)
